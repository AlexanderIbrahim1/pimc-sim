...
auto conventional_hcp_unit_cell(FP lattice_constant) -> UnitCell<FP, 3>
{
    ...
    auto basis_unit_cell_sites = std::vector {
        ...
        lattice_constant* Point {0.0, std::sqrt(3.0 / 4.0),  0.0                 },
        lattice_constant* Point {0.0, std::sqrt(1.0 / 12.0), std::sqrt(2.0 / 3.0)},
        lattice_constant* Point {0.0, std::sqrt(4.0 / 3.0),  std::sqrt(2.0 / 3.0)}
    };
