...
if __name__ == "__main__":
    ...
    for version in range(10):
        project_info_toml_filepath = Path("..", "project_info_toml_files", "p960_coarse_pert2b_tmpl.toml")
